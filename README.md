...
Поместите сертификаты в `volumes/nginx/ssl` (обновлять каждые 3 месяца), если этой папки нет - создайте ее. Если не выполнить этот шаг - могут возникнуть проблемы с настройкой на уровне настройки ключей и доступа к сервисам.
