...
11. Это откроет файл crontab в текстовом редакторе. Добавьте строку. В самом низу файла добавьте команду для cron автоочистки и перезапуска сервисов каждые 12 часов:
```
0 0,12 * * * /usr/bin/bash /schedule-parse-service/restart-services.sh
```
